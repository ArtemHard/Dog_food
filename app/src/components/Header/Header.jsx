...
const Header = ({searchText, appHeandlerText, modalActiv, setModalActiv}) => {
        ...
        <header>
            <div className='container'>
                ...
                <nav className={style.navigationBar}>
                    ...
                    <Link to='/signin' className={style.navigation__btn__signIn} onClick={SignInHeandler}>SignIn</Link>
                    <Link to='/signup' className={style.navigation__btn__signUp} onClick={SignInHeandler}>SignUp</Link>
                </nav>
            </div>
        </header>
    )
